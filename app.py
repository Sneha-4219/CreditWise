...
st.subheader("📊 CreditWise Prediction")
...
st.info(
    "⚠️ This prediction is for educational and demonstration "
    "purposes only and should not be used as an actual lending decision."
)